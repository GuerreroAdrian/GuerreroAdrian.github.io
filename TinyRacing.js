...
updateGlobalBufferAndViews(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 1916496;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=1392192;function __emscripten_get_fetch_work_queue() {
  ...
  function _js_html_setCanvasSize(width, height, fbwidth, fbheight) {
      ...
      if (!canvas) {
        ...
        if (document.body) {
          ...
          document.getElementById("cnv").insertBefore(canvas, document.getElementById("cnv").firstChild);
        } else {
