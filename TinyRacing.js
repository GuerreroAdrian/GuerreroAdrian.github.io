...
updateGlobalBufferAndViews(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 1917664;
...
// {{PRE_LIBRARY}}
  ...
  function _SetCanvasClickCallback(callbackFunction) {
        document.getElementById("UT_CANVAS").onclick = ()=>{
          dynCall_v(callbackFunction);
        };
      }
  ...
  var _fetch_work_queue=1393360;function __emscripten_get_fetch_work_queue() {
